...
Fork the project [on GitHub](https://github.com/geut/moleculer-browser) and check out your copy locally.

```bash
$ git clone git@github.com:username/moleculer-browser.git
$ cd moleculer-browser
$ npm install
$ git remote add upstream git://github.com/geut/moleculer-browser.git
```
